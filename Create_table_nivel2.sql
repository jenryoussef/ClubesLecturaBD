CREATE TABLE lectores(
    ...
    CONSTRAINT ck_arcorepresentantelector CHECK ((id_rep_ex IS NOT NULL AND id_rep_in IS NULL)OR(id_rep_in IS NOT NULL AND id_rep_ex IS NULL)OR(id_rep_ex IS NULL AND id_rep_in IS NULL))
