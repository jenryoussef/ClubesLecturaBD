...
INSERT INTO ADFJ_LIBROS (ISBN,titulo,ano_publicacion,n_paginas,sinopsis, tema,tipo_narrativa, id_pais,id_anterior) VALUES (5944012351010,'SOLENOIDE',TO_DATE('2015','YYYY'),800,'Solenoide, escrita por el autor rumano Mircea Cărtărescu, es una novela monumental que funciona como el diario de un escritor frustrado.','NOVELA DE FILOSOFIA Y CIENCIA FICCION','NO',8,NULL); COMMIT;
INSERT INTO ADFJ_LIBROS (ISBN,titulo,ano_publicacion,n_paginas,sinopsis, tema,tipo_narrativa, id_pais,id_anterior)  VALUES (4581417251111,'RIVERS EDGE',TO_DATE('1994','YYYY'),242,'Rivers Edge retrata las oscuras realidades de la juventud japonesa durante la década de 1990.','NOVELA JUVENIL Y DRAMATICA','NO',6,NULL); COMMIT;
INSERT INTO ADFJ_LIBROS (ISBN,titulo,ano_publicacion,n_paginas,sinopsis, tema,tipo_narrativa, id_pais,id_anterior)  VALUES (1301417231212,'AL ESTE DEL EDEN',TO_DATE('1952','YYYY'),688,'Al este del Edén es una novela clásica de John Steinbeck que entrelaza las sagas de las familias Trask y Hamilton en el valle de Salinas, California, entre la Guerra de Secesión y la Primera Guerra Mundial.','NOVELA DRAMATICA Y PSICOLOGICA','NO',4,NULL); COMMIT;
INSERT INTO ADFJ_LIBROS (ISBN,titulo,ano_publicacion,n_paginas,sinopsis, tema,tipo_narrativa, id_pais,id_anterior)  VALUES (4617417231313,'LOS HERMANOS KARAMAZOV',TO_DATE('1880','YYYY'),1232,'La obra cumbre de Fiódor Dostoyevski es una tragedia filosófica que gira en torno al asesinato del terrateniente Fiódor Karamázov.','NOVELA FILOSOFICA Y PSICOLOGICA','NO',9,NULL); COMMIT;
INSERT INTO ADFJ_LIBROS (ISBN,titulo,ano_publicacion,n_paginas,sinopsis, tema,tipo_narrativa, id_pais,id_anterior)  VALUES (1301417231414,'SEÑORITA MACINTOSH, MI QUERIDA',TO_DATE('1965','YYYY'),1189,'Miss MacIntosh, My Darling es una novela de Marguerite Young. La autora la describió como una exploración de las ilusiones, las alucinaciones y los errores de juicio en las vidas individuales, teniendo como escenario central el paraíso de un adicto al opio.','NOVELA PSICOLIGICA Y UNA EPOPEYA PICARESCA','NO',4,NULL); COMMIT;
INSERT INTO ADFJ_LIBROS (ISBN,titulo,ano_publicacion,n_paginas,sinopsis, tema,tipo_narrativa, id_pais,id_anterior)  VALUES (1301417231515,'LA SEÑORA CALIBAN',TO_DATE('1982','YYYY'),128,'La señora Caliban es una novela corta de Rachel Ingalls que narra la historia de Dorothy, una ama de casa solitaria atrapada en un matrimonio infeliz tras la pérdida de un hijo.','NOVELA CORTA DE FANTASIA, SATIRA SOCIAL Y ROMANCE','NO',4,NULL); COMMIT;
